<template>
  ...
  <div class="flex flex-col justify-center items-center flex-wrap -mt-12">
    <div class="flex gap-1 mb-6 select-none">
    ...
    <table v-else class="table-auto mt-4">
...
const items = ref([
  { name: "long sword +1", quantity: 1, copperSellValue: 1 },
  { name: "chain mail", quantity: 1, copperSellValue: 4444 },
  { name: "potion of healing", quantity: 3, copperSellValue: 22 },
  { name: "potion of invisibility", quantity: 1, copperSellValue: 55555 },
  { name: "scroll of fireball", quantity: 1, copperSellValue: 333 },
  { name: "staff of the magi", quantity: 1, copperSellValue: 666666 },
]);
