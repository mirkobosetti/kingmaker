<template>
  ...
  <div class="flex flex-col justify-center items-center flex-wrap">
    <div class="flex gap-2 w-full p-2 max-w-7xl flex-col sm:flex-row">
      <ul class="sm:hidden flex flex-wrap text-sm font-medium text-center text-gray-500 dark:text-gray-400">
        <li class="me-2">
      ...
      <div class="sm:w-1/3 p-2">
        ...
        <div class="sm:scrollable">
          <draggable v-model="turns" tag="ul" :animation="300" v-if="false">
            <template #item="{ element: turn }">
              <li
                class="relative w-full p-2 mb-1 border-2 rounded-md flex gap-1 justify-between text-white select-none cursor-grab items-center"
                :class="{
                  'border-darkgreen bg-lightgreen': turn.type === 'player',
                  'border-red-500 bg-red-400': turn.type === 'enemy',
                }"
              >
                <div class="flex gap-2">
                  <!-- input for initiative -->
                  <input
                    v-model="turn.initiative"
                    class="bg-transparent text-white text-lg w-6 outline-none border-none text-center"
                  />
                  <!-- input for name -->
                ...
                <div class="h-7">
                  <button
                    v-if="turn.dead"
                    class="relative text-white rounded-md px-1 py-1 text-xs font-bold z-10 bg-darkgreen"
                    @click="turn.dead = false"
                  >
                    <svg
                  ...
                  <button
                    class="relative text-white ml-1 rounded-md px-1 py-1 text-xs font-bold cursor-pointer z-10"
                    :class="{ 'bg-darkgreen': turn.type === 'player', 'bg-red-700': turn.type === 'enemy' }"
                    @click="kill(turn)"
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
          ...
          <ul>
            ...
            >
              <div class="flex flex-1 justify-between">
                ...
                <input
                  v-model="turn.name"
                  class="bg-transparent text-white text-lg outline-none border-none flex-1 w-full"
                />
                <!-- input for hp damage dealt -->
                <div class="flex gap-1 items-center">
                  ...
                  <input
                    v-model="turn.damage"
                    class="bg-transparent text-white text-lg w-8 outline-none border-none text-center"
                  />
                </div>
              </div>
              <div class="h-7">
        ...
        <div class="flex gap-1 justify-between items-center mt-5">
          <button
            class="py-2 px-4 text-white uppercase bg-lightgreen rounded-md hover:bg-darkgreen border-2 border-darkgreen"
            @click="addPlayer"
          >
            player
          </button>
          ...
          <button
            class="py-2 px-4 text-white uppercase bg-red-400 rounded-md hover:bg-red-500 border-2 border-red-500"
            @click="addEnemy"
          >
            enemy
          </button>
      ...
      <div class="border border-darkgreen sm:w-2/3 p-2">mappa</div>
    </div>
  </div>
</template>
